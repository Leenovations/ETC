...
#-------------------------------------------------------------------------------------#
Bed = pd.read_csv('/media/src/hg19/01.Methylation/00.Bed/CGI.bed',
                sep='\t',
...
Intersect = round(Intersect.groupby(['Chromosome', 'Start', 'End', 'Strand']).mean(), 2)
Intersect = Intersect.fillna('NaN')

Intersect.to_csv(f'/labmed/01.AML/01.WGBS/240205.AML.150bp.CGI.Methyl.txt',
                sep='\t',
                index=False)

Intersect_mean = Intersect.mean()
Intersect_mean.to_csv(f'/labmed/01.AML/01.WGBS/240205.AML.150bp.CGI.Mean.Methyl.txt',
                      sep='\t',
                      header='infer',
                      index=False)
#-------------------------------------------------------------------------------------#