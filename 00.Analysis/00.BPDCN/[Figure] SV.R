...
Acceptor_one <- read.table('/labmed/00.Code/ToolBox/00.Analysis/00.BPDCN/Circos/00.Translocation/BPDCN.chr.link.acceptor.sorted.1.bed',
                            ...
                            col.names=c('chr','start','end', 'gene'))
#------------------------------------------------------------------------------#
# Donor_rev <- read.table('/labmed/00.Code/ToolBox/00.Analysis/00.BPDCN/Circos/00.Translocation/BPDCN.chr.link.rev.donor.sorted.1.bed',
#                         sep='\t',
#                         col.names=c('chr','start','end', 'gene'))
# Acceptor_rev <- read.table('/labmed/00.Code/ToolBox/00.Analysis/00.BPDCN/Circos/00.Translocation/BPDCN.chr.link.rev.acceptor.sorted.1.bed',
#                            sep='\t',
#                            col.names=c('chr','start','end', 'gene'))
#------------------------------------------------------------------------------#
